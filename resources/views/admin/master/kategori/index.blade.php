    ...
    <div class="card border-0 shadow-sm mb-4">
        ...
        <div class="card-body ">
            <table class="table datatable display responsive w-100">
                <thead>
                    <tr>
                        <th class="all"><b>NAMA KATEGORI</b></th>
                        <th></th>
                    </tr>
                </thead>
                <tbody>
            ...
            <div class="card-body">
                <div class="row ">
                    <div class="col-lg-12 col-md-12 text-center">
                        <p class="mt-3 mb-1 text-white"><b>TAMBAH DATA KATEGORI</b></p>
                ...
                <div class="row ">
                    <div class="col-lg-12 col-md-12">
                        <div class="form-group ">
                            ...
                            | {{ $message }}
                            @enderror</label>
                            <input type="text" class="form-control" placeholder="-" style="height: 28px" name="kategori" value="{{ old('kategori') }}">
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content" style="border-radius: 10px !important">
          <div class="card border-0 shadow-sm">
              <div class="card-body">
                  <div class="row ">
                      <div class="col-lg-12 col-md-12 text-center">
                          <p class="mt-3 mb-1 text-white"><b>UPDATE DATA KATEGORI</b></p>
                          <img src="{{ url('assets/img/logo-putih.png') }}" alt="" class="mt-4" width="100">
                      </div>
                  </div>
                  <br>
        ...
        $('.btn-update').on('click', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    window.location.assign('/master-kategori')
                },
                 error: function(err) {
